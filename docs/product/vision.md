...
3. **Universal Knowledge & Governance**: By shifting Domain, Layer, and Lifecycle governance (DoD, checklists, templates) into an MCP server, all harnesses (Claude, Cursor, Antigravity, GHCP) share the exact same standards and policies.
