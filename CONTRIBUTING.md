...
Matching uninstallers live beside the installers (`install/uninstall_<harness>.sh` / `.ps1`). They are not yet at reverse-path parity with the current installers (Epic 12).
